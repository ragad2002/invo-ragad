      ...
      <table class="table table-bordered table-striped">
        <thead>
          <tr>
            ...
            <th> name </th>
            <th> Username</th>
            <th class="text-center" style="width: 15%;">User group</th>
          ...
          <?php endif;?>
           ...
           <td class="text-center">
             <div class="btn-group">
                ...
                <a href="delete_user.php?id=<?php echo (int)$a_user['id'];?>" class="btn btn-xs btn-danger" data-toggle="tooltip" title="delet">
