      ...
      <table class="table table-bordered">
        <thead>
          <tr>
            ...
            <th class="text-center" style="width: 15%;">Group status</th>
          ...
          <?php endif;?>
           ...
           <td class="text-center">
             <div class="btn-group">
                ...
                <a href="delete_group.php?id=<?php echo (int)$a_group['id'];?>" class="btn btn-xs btn-danger" data-toggle="tooltip" title="delet">
