            ...
            <div class="pull-right">
              ...
              <div class="form-group">
                <div class="input-group">
                 ...
                 <button type="submit" name="submit" class="btn btn-default">Upload product image</button>
               </div>
              </div>
             </form>
            </div>
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th class="text-center" style="width: 20%;">Image extension</th>
